...
import { PROFILE_IMG } from "./src/data/portfolioData";
...
function InteractivePortrait({ onShowToast, onOpenAbout, onSelectCv, onOpenContact }) {
...
function Nav({
  ...
  const navLink = (label, active, onClick, extra) => (
    <button
      onClick={() => {
        onClick();
        setMobileOpen(false);
    ...
    >
      ...
      <div style={{ padding: "20px 24px 24px", display: "flex", flexDirection: "column", gap: 12, flex: 1 }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 6, marginTop: "auto", paddingTop: 8 }}>
          {(project.stack || project.tags || []).map((s) => (
...
function CaseStudy({ project, onBack, onHome, onShowToast }) {
...
function HomePage({ onSelect, onProjects, onAbout, onContact, onSelectCv, onShowToast }) {
  return (
...
function ProjectsPage({ onSelect, onBack, onSelectWebPreview, onContact }) {
  ...
  const getTagColor = (tag) => tagColors[tag] ?? "#9CA0A8";
...
function AboutPage({ onBack, onProjects, onContact, onSelectCv, onShowToast }) {
  return (
...
function StackPage({ onBack, onProjects, onContact }) {
...
function CvModal({ isOpen, onClose, onShowToast }) {
...
function PreviewModal({ project, onClose, onShowToast, onNavigateToStudy }) {
            ...
            <div style={{ background: "#17191E", border: "1px solid #24262B", borderRadius: 12, padding: "20px 22px" }}>
              ...
              {project.baselineStats && (
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 10 }}>
                  {project.baselineStats.map((st, i) => (
